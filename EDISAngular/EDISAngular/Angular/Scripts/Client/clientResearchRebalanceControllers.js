app.controller("clientResearchRebalanceController", ["clientResearchRebalanceServices", "$scope", "$modal", function (service, $scope, $modal) {
...
app.controller("addNewModelController", function ($scope, $modalInstance, rebalanceService) {
