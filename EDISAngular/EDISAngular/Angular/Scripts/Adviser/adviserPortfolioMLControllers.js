...
(function () {
    ...
    app.controller("adviserPortfolioMLLoadClientsController", ["$scope", "adviserPortfolioMLClientsGet", function ($scope, DBContext) {
        DBContext().query(function (data) {
    ...
    app.controller("adviserPortfolioMLLoanDetailsController", ["$scope", "adviserPortfolioMLLoanDetails", "$rootScope", function ($scope, DBContext, $rootScope) {
